<div tabindex="-1" x-show="isVisible == 'create-stock-product'" x-transition:enter="transition ease-out duration-200"
            ...
            <form @submit.prevent="addProductStock">
                <div class="py-4 md:py-6 px-2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <select x-model.number="stock.quantity" id="quantity"
                                ...
                                <template x-for="index in 25" :key="index">
                        ...
                        {{-- <div class="col-span-2 w-full">
                            ...
                            <select id="status" x-model="stock.status"
                ...
                <div
                    ...
                    <button type="submit"
                        ...
                        <span x-text="isLoading ? 'Loading...' : 'Add Stock Product'"></span>
                    </button>
                </div>
            </form>
        </div>
